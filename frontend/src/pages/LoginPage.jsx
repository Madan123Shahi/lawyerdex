    ...
    <div className="pt-16 min-h-screen bg-gray-50 flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-bold text-gray-800 mt-6 mb-1">Welcome back</h1>
          <p className="text-gray-500 text-sm">Sign in to your LawyerDex account</p>
        </div>
