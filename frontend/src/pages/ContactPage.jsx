...
import { contactSchema } from "../../../shared/schemas/lawyerValidators";
...
export default function ContactPage() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setApiError(
        err.normalized?.message || "Something went wrong. Please try again.",
      );
    }
  };
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Whether you have a question about finding the right lawyer, need
                help navigating the platform, or want to learn more about our
              ...
              {[
                {
                  icon: Mail,
                  label: "Email Us",
                  value: "contact@lawyerdex.com",
                  href: "mailto:contact@lawyerdex.com",
                },
                {
                  icon: Phone,
                  label: "Call Us",
                  value: "+1 (814) 300-8055",
                  href: "tel:+18143008055",
                },
                {
                  icon: MapPin,
                  label: "Location",
                ...
                <div key={label} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    {href ? (
                      <a
                        href={href}
                        className="text-primary-700 font-medium hover:text-primary-500 transition-colors"
                      >
                        {value}
                      </a>
                    ) : (
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              {success ? (
                ...
                <form
                  ...
                  className="space-y-5"
                >
                  <h2 className="font-display text-xl font-bold text-primary-700 mb-2">
                    Send a Message
                  </h2>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`input-field ${errors.subject ? "border-red-400 focus:ring-red-300" : ""}`}
                    />
                    {errors.subject && (
